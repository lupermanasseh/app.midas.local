...
<div class="container">
    ...
    <div class="row">
        <div class="col s12 subject-header">
            <h5 class="teal-text">EDIT LOAN DEDUCTION DETAILS</h5>
        </div>
    </div>
    <div class="row">
        <div class="col s12 subject-header">
            <span><a href="/loanDeduction/listings"><i class="small material-icons tooltipped" data-position="bottom"
...
<div class="input-field col s12">
    ...
    <input id="amount" name="amount" value="{{$deduction->amount_deducted}}" type="text" class="validate">
...
<div class="row">
    ...
    <div class="input-field col s12 m6 l6">
        <input id="entry_date" name="entry_date" value="{{$deduction->entry_month->toDateString()}}" type="text"
            class="validate datepicker">
        <label for="entry_date">Date</label>
    </div>

</div>
<button type="submit" class="btn">Edit Loan Deduction</button>
</form>
</div>
</div>
@endsection