    ...
    <table class="">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a
                        href="/Dashboard/user/loans/{{$myProduct->id}}">{{number_format($myProduct->amount_approved+$myProduct->topup_amount-$myProduct->totalLoanDeductions($myProduct->id),2,'.',',')}}</a>
                </td>
            </tr>
            @endforeach
            @else
    ...
    <table class="">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a
                        href="/Dashboard/user/loans/{{$inactive->id}}">{{number_format($inactive->amount_approved+$inactive->topup_amount-$inactive->totalLoanDeductions($inactive->id),2,'.',',')}}</a>
                </td>
            </tr>
            @endforeach
            @else
