...
<div class="container">
    ...
    <div class="row">
        <form class="col s12" method="POST" action="/loanProduct/update/{{$loanPrdt->id}}">
            {{ csrf_field() }}
            <div class="row">
                <div class="input-field col s12">
                    <input id="loan_name" name="loan_name" value="{{$loanPrdt->description}}" type="text" class="validate" required>
