...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="input-field col s4">
            <input id="last_name" name="last_name" value="<?php echo e($user->last_name); ?>" type="text" class="validate" required>
    ...
    <div class="row">
        ...
        <div class="input-field col s4">
            <input id="dob" name="dob" value="<?php echo e($user->dob); ?>" type="date" class="validate" required>
    ...
    <div class="row">
        <div class="input-field col s6">
            <input id="home_add" name="home_add" value="<?php echo e($user->home_add); ?>" type="text" class="validate" required>
