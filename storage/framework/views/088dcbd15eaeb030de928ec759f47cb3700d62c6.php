<figure class="review">
    <h5 class="review__heading">[ <a href='/Dashboard/myPendingLoans/<?php echo e(auth()->id()); ?>'><?php echo e($myPendingApp->count()); ?></a> ]
        Pending
        Application(s)</h5>
    ...
    <figcaption class="review__user">
        <img src="<?php echo e(asset('images/ternenge.jpg')); ?>" alt="review photo" class="review__photo">
