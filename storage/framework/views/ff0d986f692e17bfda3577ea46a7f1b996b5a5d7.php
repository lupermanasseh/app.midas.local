...
<div class="container">
    ...
    <div class="row">
        <div class="col s12 m3 l3">
            <a href="/consolidatedloanbalance/excel/<?php echo e($from); ?>/<?php echo e($to); ?>" class="btn">DOWNLOAD EXCEL</a>
        </div>
        <div class="col s12 m3 l3">
            <a href="/consolidatedloanbalance/pdf/<?php echo e($from); ?>/<?php echo e($to); ?>" target="_blank" class="btn">DOWNLOAD PDF</a>
        </div>
    </div>
    <?php else: ?>
    <?php endif; ?>
            ...
            <table class="highlight">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($to); ?></td>
                        <td>
                          <a href="/user/landingPage/<?php echo e($listing->user_id); ?>" target="_blank"><?php echo e(number_format($listing->userBalancesByDate($collection,$listing->user_id),2,'.',',')); ?></a>
