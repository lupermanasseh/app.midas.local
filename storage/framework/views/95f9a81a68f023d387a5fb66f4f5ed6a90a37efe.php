...
<div class="container">
    ...
    <div class="row">
        <div class="col s12">
            ...
            <?php echo $__env->make('MonthlySaving.savingsTable',$savings, \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?> <?php echo e($savings->links()); ?> <?php else: ?>
