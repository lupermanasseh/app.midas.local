...
<div class="container">
    ...
    <div class="row user-profiles">
        <div class="col s12 m3 l3 profile">
            ...
            <img src="<?php echo e(url('storage/photos/'.$profile->photo)); ?>" alt="" class="profile__photo">
            <span><a href="/photo/<?php echo e($profile->id); ?>" class="pink-text darken-2">Edit Photo</a></span>
            <?php else: ?>
            <img src="<?php echo e(url('images/girl-1.png')); ?>" alt="" class="profile__photo">
            <span><a href="/photo/<?php echo e($profile->id); ?>" class="pink-text darken-2">Choose Photo</a></span>
            <?php endif; ?>
    ...
    <div class="row user-profiles">
        ...
        <div class="col s12 m9 l9  profile-detail">
            ...
            <table class="highlight">
                ...
                <tbody>
                    <tr>
                        <td><?php echo e($profile->bank->bank_branch); ?></td>
                        <td><?php echo e($profile->bank->sort_code); ?></td>
                        <td><?php echo e($profile->bank->acct_name); ?></td>
                    </tr>
                </tbody>
            </table>
            <?php else: ?>
    ...
    <div class="row user-profiles">
        ...
        <div class="col s12  profile-detail">
            ...
            <table class="highlight">
                ...
                <tbody>
                    <?php $__currentLoopData = $SavingReview; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($item->created_at->toDateString()); ?></td>
                        <td><?php echo e(number_format($item->current_amount,2,'.',',')); ?></td>
                        <td><?php echo e($item->status); ?></td>
                        <td>
                            <?php if($item->status=='Inactive'): ?>
                            <a href="#" class="btn red darken-3"><?php echo e($item->status); ?></a>
                            <?php else: ?>
                            <a href="/saving/inactive/<?php echo e($item->id); ?>" class="btn grey darken-3">Deactivate</a>
                            <?php endif; ?>
                        </td>
                    </tr>
