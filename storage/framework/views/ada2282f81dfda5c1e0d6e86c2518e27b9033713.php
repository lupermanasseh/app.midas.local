...
<div class="container">
    ...
    <div class="row">
        <div class="col s12 subject-header">
            <h6 class="teal-text">USER LOAN DEDUCTION(s)</h6>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col s12">
            ...
            <table class="highlight">
                ...
                <tbody>
                    <?php $__currentLoopData = $recent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $myItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
