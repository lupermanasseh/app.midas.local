        ...
        <form class="col s12" method="POST" action="/productRepay/store">
            ...
            <div class="row">
                <div class="input-field col s12 m6 l6">
                    <input disabled id="payment_id" name="payment_id" value="<?php echo e($subscription->user->payment_number); ?>" type="text" class="validate">
                    <label for="payment_id">Payment ID</label>
                </div>
                <div class="input-field col s12 m6 l6">
                    <input id="user_id" name="user_id" value="<?php echo e($subscription->user->id); ?>" type="hidden">
                </div>
                <div class="input-field col s12 m6 l6">
            ...
            <div class="row">
                ...
                <div class="input-field col s12 m6 l6">
                    <select id="product" name="product">
                        <option value="<?php echo e($subscription->product->id); ?>"><?php echo e($subscription->product->name); ?></option>
                    </select>
