...
<div class="container">
    ...
    <div class="row">
        <div class="col s12 subject-header">
            <span><a href="/userDetails/<?php echo e($nok->user->id); ?>"><i class="small material-icons tooltipped"
    ...
    <div class="row">
        ...
        <form class="col s12" method="POST" action="/updateNok/<?php echo e($nok->id); ?>">
            ...
            <div class="row">
                ...
                <div class="input-field col s4">
                    <input id="first_name" name="first_name" value="<?php echo e($nok->first_name); ?>" type="text" class="validate"
                        required>
                    <label for="first_name">Surname</label>
                </div>

                <div class="input-field col s4">
                    <input id="last_name" name="last_name" value="<?php echo e($nok->last_name); ?>" type="text" class="validate"
                        required>
