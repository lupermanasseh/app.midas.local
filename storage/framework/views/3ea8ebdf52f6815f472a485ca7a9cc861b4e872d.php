...
<div class="container">
    ...
    <div class="row user-profiles">
        ...
        <div class="col s12 m3 l3 profile">
            ...
            <span><i class="small material-icons pink-text lighten-4">looks</i></span>
            <span class="profile__user-name"><?php echo e($userLoan->loan->description); ?></span>
            <span class="profile__user-name">Tenor <?php echo e($userLoan->loan->tenor); ?> [ <?php echo e($userLoan->custom_tenor); ?> ]</span>
        ...
        <div class="col s12 m3 l3 profile">
            ...
            <span
                class="profile__user-name"><?php echo e($userLoan->loan_start_date->diffForHumans($userLoan->loan_end_date->toFormattedDateString())); ?></span>
