...
<div class="container">
    ...
    <div class="row user-profiles">
        <div class="col s12 m3 l3 profile">
            ...
            <a href="/userDetails/<?php echo e($user->id); ?>"><img src="<?php echo e(url('storage/photos/'.$user->photo)); ?>" alt=""
    ...
    <div class="row user-profiles">
        ...
        <p><a href="/ts/withdrawal/<?php echo e($user->id); ?>" class="btn pink darken-3">WITHDRAW</a> <a
                href="/new/ts/<?php echo e($tsr->user_id); ?>" class="btn">New TS</a></p>
    </div>
    <?php else: ?>
    <p>No available Target Saving subscriptions</p>
    <p><a href="/new/ts/<?php echo e($tsr->user_id); ?>" class="btn">New TS</a></p>
    <?php endif; ?>
</div>
